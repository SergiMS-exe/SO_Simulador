...
// void* __real_OperatingSystem_InterruptLogic(int entryPoint);
// void* __real_OperatingSystem_PrepareDaemons(int programListDaemonsBase);
...
// void HOOK(OperatingSystem_InterruptLogic)(int entryPoint) {
// 	Clock_Update();
// 	HOOKEABLE(OperatingSystem_InterruptLogic)(entryPoint);
// }
...
// void HOOK(OperatingSystem_PrepareDaemons)(int programListDaemonsBase) {
// 	HOOKEABLE(OperatingSystem_PrepareDaemons)(programListDaemonsBase);
// }
// void __wrap_OperatingSystem_PrepareDaemons(int programListDaemonsBase) {
// 	__real_OperatingSystem_PrepareDaemons(programListDaemonsBase);
// 	OperatingSystem_PrepareTeachersDaemons(programListDaemonsBase);
// }
/******************************************************************************/
